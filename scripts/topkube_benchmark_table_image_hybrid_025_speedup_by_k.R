...
row.header.text   = c("5","10","20","40","80","160","320")
row.header.text   = c(rev(row.header.text),expression(paste("k \\ %"))) # expression(theta percentile))
...
pdf("analysis/plots/speedup_025_by_k.pdf",width=8,height=3.2,pointsize=9,family="Helvetica")
par(mar=rep(0,4))
