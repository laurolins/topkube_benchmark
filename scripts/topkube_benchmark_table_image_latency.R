...
levels = c(1e-3, 5e-3, 1e-2, 5e-2, 1e-1, 0.25, 0.5, 1, 5, 1000)
...
colors = c(rev(blues[3:6]),reds[2:7])
...
pdf("analysis/plots/latency_by_threshold.pdf",width=8,height=6.5,pointsize=9,family="Helvetica")
par(mar=rep(0,4))
...
create.legend(c(-1,10),c(-1,-0.3),head(colors,-1),
